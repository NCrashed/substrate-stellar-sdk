...
//!
// This code has been automatically generated on 2021-07-13
// using the code in folder `/autogenerator`// Do not edit this file manually!
...
impl XdrCodec for ScpStatementType {
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match enum_value {
            ...
            _ => Err(DecodeError::InvalidEnumDiscriminator {
...
/// Autogenerated definition for type AssetAlphaNum4
#[allow(dead_code)]
#[derive(Debug, Clone, Eq, PartialEq)]
...
/// Autogenerated definition for type AssetAlphaNum12
#[allow(dead_code)]
#[derive(Debug, Clone, Eq, PartialEq)]
...
impl XdrCodec for LiquidityPoolConstantProductParameters {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        self.asseta.to_xdr_buffered(write_stream);
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        Ok(LiquidityPoolConstantProductParameters {
            asseta: Asset::from_xdr_buffered(read_stream)?,
...
impl XdrCodec for LedgerCloseMetaV0 {
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        Ok(LedgerCloseMetaV0 {
            ...
            tx_set: TransactionSet::from_xdr_buffered(read_stream)?,
            tx_processing: UnlimitedVarArray::<TransactionResultMeta>::from_xdr_buffered(
                read_stream,
            )?,
            upgrades_processing: UnlimitedVarArray::<UpgradeEntryMeta>::from_xdr_buffered(
                read_stream,
            )?,
...
impl XdrCodec for Auth {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        self.unused.to_xdr_buffered(write_stream);
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        Ok(Auth {
            unused: i32::from_xdr_buffered(read_stream)?,
        })
    }
}
...
/// Autogenerated definition for type TopologyResponseBody
#[allow(dead_code)]
#[cfg(feature = "all-types")]
#[derive(Debug, Clone, Eq, PartialEq)]
...
#[cfg(feature = "all-types")]
impl XdrCodec for TopologyResponseBody {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
...
/// Autogenerated definition for type OperationIdId
#[allow(dead_code)]
#[cfg(feature = "all-types")]
#[derive(Debug, Clone, Eq, PartialEq)]
...
#[cfg(feature = "all-types")]
impl XdrCodec for OperationIdId {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        self.source_account.to_xdr_buffered(write_stream);
        self.seq_num.to_xdr_buffered(write_stream);
...
impl XdrCodec for TransactionSignaturePayload {
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        Ok(TransactionSignaturePayload {
            network_id: Hash::from_xdr_buffered(read_stream)?,
            tagged_transaction: TransactionSignaturePayloadTaggedTransaction::from_xdr_buffered(
                read_stream,
            )?,
        })
    }
...
impl XdrCodec for Curve25519Secret {
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        Ok(Curve25519Secret {
            key: <[u8; 32]>::from_xdr_buffered(read_stream)?,
        })
    }
}
...
impl XdrCodec for HmacSha256Mac {
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        Ok(HmacSha256Mac {
            mac: <[u8; 32]>::from_xdr_buffered(read_stream)?,
        })
    }
}
...
impl XdrCodec for ScpStatementPledges {
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match ScpStatementType::from_xdr_buffered(read_stream)? {
            ScpStatementType::ScpStPrepare => Ok(ScpStatementPledges::ScpStPrepare(
                ScpStatementPrepare::from_xdr_buffered(read_stream)?,
            )),
            ScpStatementType::ScpStConfirm => Ok(ScpStatementPledges::ScpStConfirm(
                ScpStatementConfirm::from_xdr_buffered(read_stream)?,
            )),
            ScpStatementType::ScpStExternalize => Ok(ScpStatementPledges::ScpStExternalize(
                ScpStatementExternalize::from_xdr_buffered(read_stream)?,
            )),
            ScpStatementType::ScpStNominate => Ok(ScpStatementPledges::ScpStNominate(
                ScpNomination::from_xdr_buffered(read_stream)?,
            )),
        }
    }
}
...
impl XdrCodec for LedgerEntryData {
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match LedgerEntryType::from_xdr_buffered(read_stream)? {
            ...
            LedgerEntryType::LiquidityPool => Ok(LedgerEntryData::LiquidityPool(
                LiquidityPoolEntry::from_xdr_buffered(read_stream)?,
            )),
        }
    }
}
...
impl XdrCodec for LedgerKey {
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match LedgerEntryType::from_xdr_buffered(read_stream)? {
            ...
            LedgerEntryType::LiquidityPool => Ok(LedgerKey::LiquidityPool(
                LedgerKeyLiquidityPool::from_xdr_buffered(read_stream)?,
            )),
        }
    }
}
...
impl XdrCodec for StellarValueExt {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            StellarValueExt::StellarValueBasic => {
                StellarValueType::StellarValueBasic.to_xdr_buffered(write_stream)
            }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match StellarValueType::from_xdr_buffered(read_stream)? {
            ...
            StellarValueType::StellarValueSigned => Ok(StellarValueExt::StellarValueSigned(
                LedgerCloseValueSignature::from_xdr_buffered(read_stream)?,
            )),
        }
    }
}
...
impl XdrCodec for LedgerUpgrade {
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match LedgerUpgradeType::from_xdr_buffered(read_stream)? {
            LedgerUpgradeType::LedgerUpgradeVersion => Ok(LedgerUpgrade::LedgerUpgradeVersion(
                Uint32::from_xdr_buffered(read_stream)?,
            )),
            LedgerUpgradeType::LedgerUpgradeBaseFee => Ok(LedgerUpgrade::LedgerUpgradeBaseFee(
                Uint32::from_xdr_buffered(read_stream)?,
            )),
            LedgerUpgradeType::LedgerUpgradeMaxTxSetSize => Ok(
                LedgerUpgrade::LedgerUpgradeMaxTxSetSize(Uint32::from_xdr_buffered(read_stream)?),
            ),
            LedgerUpgradeType::LedgerUpgradeBaseReserve => Ok(
                LedgerUpgrade::LedgerUpgradeBaseReserve(Uint32::from_xdr_buffered(read_stream)?),
            ),
        }
    }
}
...
impl XdrCodec for BucketEntry {
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match BucketEntryType::from_xdr_buffered(read_stream)? {
            BucketEntryType::Liveentry => Ok(BucketEntry::Liveentry(
                LedgerEntry::from_xdr_buffered(read_stream)?,
            )),
            BucketEntryType::Initentry => Ok(BucketEntry::Initentry(
                LedgerEntry::from_xdr_buffered(read_stream)?,
            )),
            BucketEntryType::Deadentry => Ok(BucketEntry::Deadentry(LedgerKey::from_xdr_buffered(
                read_stream,
            )?)),
            BucketEntryType::Metaentry => Ok(BucketEntry::Metaentry(
                BucketMetadata::from_xdr_buffered(read_stream)?,
            )),
        }
    }
}
...
impl XdrCodec for ScpHistoryEntry {
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match i32::from_xdr_buffered(read_stream)? {
            0 => Ok(ScpHistoryEntry::V0(ScpHistoryEntryV0::from_xdr_buffered(
                read_stream,
            )?)),
...
impl XdrCodec for LedgerCloseMeta {
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match i32::from_xdr_buffered(read_stream)? {
            0 => Ok(LedgerCloseMeta::V0(LedgerCloseMetaV0::from_xdr_buffered(
                read_stream,
            )?)),
...
impl XdrCodec for PeerAddressIp {
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match IpAddrType::from_xdr_buffered(read_stream)? {
            IpAddrType::IPv4 => Ok(PeerAddressIp::IPv4(<[u8; 4]>::from_xdr_buffered(
                read_stream,
            )?)),
            IpAddrType::IPv6 => Ok(PeerAddressIp::IPv6(<[u8; 16]>::from_xdr_buffered(
                read_stream,
            )?)),
        }
    }
...
impl XdrCodec for SurveyResponseBody {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            SurveyResponseBody::SurveyTopology(value) => {
                SurveyMessageCommandType::SurveyTopology.to_xdr_buffered(write_stream);
                value.to_xdr_buffered(write_stream)
            }
        }
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match SurveyMessageCommandType::from_xdr_buffered(read_stream)? {
            SurveyMessageCommandType::SurveyTopology => Ok(SurveyResponseBody::SurveyTopology(
                TopologyResponseBody::from_xdr_buffered(read_stream)?,
            )),
        }
    }
}
...
impl XdrCodec for StellarMessage {
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match MessageType::from_xdr_buffered(read_stream)? {
            MessageType::ErrorMsg => Ok(StellarMessage::ErrorMsg(Error::from_xdr_buffered(
                read_stream,
            )?)),
            MessageType::Hello => Ok(StellarMessage::Hello(Hello::from_xdr_buffered(
                read_stream,
            )?)),
            MessageType::Auth => Ok(StellarMessage::Auth(Auth::from_xdr_buffered(read_stream)?)),
            MessageType::DontHave => Ok(StellarMessage::DontHave(DontHave::from_xdr_buffered(
                read_stream,
            )?)),
            MessageType::GetPeers => Ok(StellarMessage::GetPeers),
            MessageType::Peers => Ok(StellarMessage::Peers(
                LimitedVarArray::<PeerAddress, 100>::from_xdr_buffered(read_stream)?,
            )),
            MessageType::GetTxSet => Ok(StellarMessage::GetTxSet(Uint256::from_xdr_buffered(
                read_stream,
            )?)),
            MessageType::TxSet => Ok(StellarMessage::TxSet(TransactionSet::from_xdr_buffered(
                read_stream,
            )?)),
            MessageType::Transaction => Ok(StellarMessage::Transaction(
                TransactionEnvelope::from_xdr_buffered(read_stream)?,
            )),
            MessageType::SurveyRequest => Ok(StellarMessage::SurveyRequest(
                SignedSurveyRequestMessage::from_xdr_buffered(read_stream)?,
            )),
            MessageType::SurveyResponse => Ok(StellarMessage::SurveyResponse(
                SignedSurveyResponseMessage::from_xdr_buffered(read_stream)?,
            )),
            MessageType::GetScpQuorumset => Ok(StellarMessage::GetScpQuorumset(
                Uint256::from_xdr_buffered(read_stream)?,
            )),
            MessageType::ScpQuorumset => Ok(StellarMessage::ScpQuorumset(
                ScpQuorumSet::from_xdr_buffered(read_stream)?,
            )),
            MessageType::ScpMessage => Ok(StellarMessage::ScpMessage(
                ScpEnvelope::from_xdr_buffered(read_stream)?,
            )),
            MessageType::GetScpState => Ok(StellarMessage::GetScpState(Uint32::from_xdr_buffered(
                read_stream,
            )?)),
        }
    }
...
impl XdrCodec for AuthenticatedMessage {
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match Uint32::from_xdr_buffered(read_stream)? {
            0 => Ok(AuthenticatedMessage::V0(
                AuthenticatedMessageV0::from_xdr_buffered(read_stream)?,
            )),
...
/// Autogenerated definition for type OperationId
#[allow(dead_code)]
#[cfg(feature = "all-types")]
#[derive(Debug, Clone, Eq, PartialEq)]
...
#[cfg(feature = "all-types")]
impl XdrCodec for OperationId {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            OperationId::EnvelopeTypeOpId(value) => {
                EnvelopeType::EnvelopeTypeOpId.to_xdr_buffered(write_stream);
                value.to_xdr_buffered(write_stream)
            }
            OperationId::Default(code) => code.to_xdr_buffered(write_stream),
        }
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match EnvelopeType::from_xdr_buffered(read_stream)? {
            EnvelopeType::EnvelopeTypeOpId => Ok(OperationId::EnvelopeTypeOpId(
                OperationIdId::from_xdr_buffered(read_stream)?,
            )),
            code => Ok(OperationId::Default(code)),
        }
    }
}
...
impl XdrCodec for TransactionSignaturePayloadTaggedTransaction {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            ...
            TransactionSignaturePayloadTaggedTransaction::Default(code) => {
                code.to_xdr_buffered(write_stream)
            }
        }
    }
...
impl XdrCodec for EndSponsoringFutureReservesResult {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            ...
            EndSponsoringFutureReservesResult::Default(code) => code.to_xdr_buffered(write_stream),
        }
    }
